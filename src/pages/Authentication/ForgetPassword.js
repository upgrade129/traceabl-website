...
import logolight from "../../assets/images/tlogo.jpg"
            ...
            <div className="col-md-8 col-lg-6 col-xl-5">
              <div>
                ...
                <a href="/" className="mb-5 d-block auth-logo">
                  <img src={logo} alt="" height="75" className="logo logo-dark" />
                  <img src={logolight} alt="" height="75" className="logo logo-light" />
                </a>
                <Card>
                  ...
                  <CardBody className="p-4">
                    ...
                    <div className="text-center mt-2">
                      ...
                      <p className="text-muted">Reset Password with Traceabl.</p>
                    </div>
